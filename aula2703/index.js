...
function withdraw(){
    inquirer.prompt([
        ...
        if(!checkAccount(accountName)){ // Reaproveitando a função de checagem que já existe
...
function removeAmount(accountName, amount){
    ...
    console.info(chalk.bgYellowBright.white(`O saque no valor: ${amount} foi realizado na conta: ${accountName}`))
}